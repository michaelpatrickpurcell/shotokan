...
\reversemarginpar\marginnote{\center\includegraphics[height=2.5cm]{Images/oi_zuki_pose_right.png}\qquad\qquad \reflectbox{\includegraphics[height=2.5cm]{Images/pinan_sandan_throw_pose.png}}}[-4.0cm]
...
\input{taikyoku_shodan_kata.tex}
}
\normalmarginpar\marginnote{\section*{Gameplay}
%\input{shihozuki_ichi_steps.tex}
\input{taikyoku_shodan_steps.tex}
}[-15.5875cm]
